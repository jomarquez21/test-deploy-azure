...
final class Version20240702000406 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Fix missing field "descuento_pactado" at view `v_poliza_facturas`.';
    }
        ...
        $sqlString = <<<'SQL'
            CREATE VIEW v_poliza_facturas AS
                SELECT
                    ...
                    invje.discount_amount AS descuento_pactado,
